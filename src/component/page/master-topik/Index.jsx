...
const dataFilterSort = [
  { Value: "[Nama Topik] asc", Text: "Nama [↑]" },
  { Value: "[Nama Topik] desc", Text: "Nama [↓]" },
];
...
export default function MasterTopikIndex({ onChangePage }) {
  ...
  const [currentFilter, setCurrentFilter] = useState({
    ...
    sort: "[Nama Topik] asc",
    status: "Aktif",
    jenis: "", // jenis pencarian, jika ada
  });
  ...
  function handleSetStatus(id) {
    setIsLoading(true);
    setIsError(false);
    UseFetch(API_LINK + "MasterTopik/SetStatusTopik", {
      idTopik: id,
    })
      .then((data) => {
        if (data === "ERROR" || data.length === 0) setIsError(true);
          ...
          SweetAlert(
            "Sukses",
            "Status data topik berhasil diubah menjadi " + data[0].Status,
            "success"
          );
    ...
    const fetchData = async () => {
      ...
      try {
        const data = await UseFetch(
          API_LINK + "MasterTopik/GetDataTopik",
          currentFilter
        );
      ...
      <div className="d-flex flex-column">
        {isError && (
          <div className="flex-fill">
            <Alert
              type="warning"
              message="Terjadi kesalahan: Gagal mengambil data Topik."
            />
          </div>
        )}
        <div className="flex-fill">
